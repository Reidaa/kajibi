...
const StoryPage = () => {
	...
	return (
		<div className="fixed inset-0 z-50 bg-black">
			...
			<div
				className="hidden h-full w-full bg-white md:grid"
				style={{ gridTemplateColumns: "1fr 56.25vh minmax(0,56.25vh) 1fr" }}
			>
				<div />
				<div
				...
				<div className="relative bg-white">
					...
					<div className="h-full">
						<StoryMetadata story={target} currentPanel={target.panels[0]} />
					</div>
				</div>
				<div />
			</div>
